#!/usr/bin/env node
'use strict';
/** SciFact 全管线：token_2stage + 图平滑融合 */
...
async function main(){
  console.log('\n=== SciFact 全管线 Benchmark ===\n');
  const{LawVexus}=require('/home/amd/HEZIMENG/law-vexus');
  const v=new LawVexus('/tmp/sf_full');
  ...
  console.log(`tokenChamferTwoStage: ${hasT2S}, shapeLaplacianPipeline: ${hasLap}`);
  ...
  console.log('  SciFact Full Pipeline');
  console.log('-'.repeat(60));
